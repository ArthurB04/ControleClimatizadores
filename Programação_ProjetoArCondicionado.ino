...
const char* ssid = "AbatCaverna";  //Nome do Wi-Fi
const char* password = "semchuveiro101"; //Senha do Wi-Fi

//Dados do MQTT Broker
const char* mqtt_server = "projetoarthur.duckdns.org"; //Localização do MQTT Broker
const char* mqtt_username = "admin"; //Usuario do Broker
const char* mqtt_password = "arthuraws"; //Usuario do Broker
...
dtostrf(Sensor.getTempCByIndex(0), 1, 2, temperatura_str); //temperatura - leitura para o dashboard
